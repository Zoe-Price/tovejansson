...
',
    ...
    },
    {
        ...
        text: 'I kapitlet Anna beskrivs Anna som vacker, med hår som "grov gräs" och rosa kinder. Hennes armar dyker ner i diskvattnet "som pelare." Men relationen mellan Anna och berättaren är spänd och ibland svår.
En konflikt kring konst och publicering uppstår. Anna arbetar på vad berättaren beskriver som "ett skräpigt företag som inte publicerar Platon." Det finns spänning kring färgtryck och illustrationer, där Anna insisterar på att saker måste göras på ett visst sätt, trots berättarens oenighet. En annan återkommande händelse handlar om en korgstol som pappan attackerar med sin bajonett, vilket får alla att hoppa och ropa. Detta avbryter hans balalajkaspel, och efteråt slutar han spela helt.
Anna visar också sitt intresse för litteratur. Hon studerar den trettonde versen av "Lord Henry and Fair Hilda," där "saker faktiskt börjar hända." Hon har även en älskare som beskrivs som en krigare, klädd i röda byxor med guldbroderier och en drake. Trots spänningarna delar Anna och berättaren en stunds tillfällig fred när de bygger ett hus under köksbordet. Berättaren medger dock att de gör detta mest av artighet.
Kapitlet tar också upp minnen av fågelbärsblommor på marknaden, som påminner om Mummys födelsedag och hur dessa blommors ankomst alltid tycks orsaka problem.
Genom kapitlet finns en underliggande känsla av spänning mellan att hålla sig artig och hantera verkliga konflikter. Berättaren biter ofta ihop för att bevara freden, medan Anna framställs som något envis i sina åsikter och vanor. Kapitlet fångar på ett fint sätt komplexiteten i en relation där människor måste samsas trots sina olikheter.'
,
    ...
    },
    {
        ...
        text: 'Albert är en pojke som är sex dagar äldre än henne. De tillbringar tid tillsammans vid sjön, där Albert sitter i sin båt och fiskar. Berättaren tycker att det är hemskt att sätta krokar i fiskar medan de lever, men Albert förklarar att det är så man fiskar. De grälar lite, men fortsätter att umgås.
En dag börjar de bygga en flotte tillsammans. De använder plankor och spikar och räknar hammarslagen högt medan de arbetar. Efter att flotten är klar tar de ut den i vattnet och paddlar långsamt iväg. De når en plats där dimman börjar lägga sig över vattnet. Albert är bestämd och säger att de inte ska gå längre eftersom det kan bli farligt.
När de är ute i dimman ser Albert en fågel som flyter i vattnet. Fågeln är skadad och försöker fly, men Albert fångar den försiktigt. Berättaren tycker synd om fågeln och vill låta den leva, men Albert säger att den är för sjuk för att klara sig. Med en kniv avslutar Albert fågelns lidande, vilket gör berättaren ledsen och skakad. Albert försöker trösta genom att säga att det var nödvändigt och att det inte finns något mer att göra.
Slutligen klarnar dimman, och de paddlar tillbaka. Albert visar att han alltid hittar lösningar, även i svåra situationer. Berättaren känner sig lugnare när dimman lättar, och de återvänder hem tillsammans.
',
    ...
    },
    {
        ...
        text: 'Det är en sommar där båthuset står tomt, och Kallebisin fiskar hela tiden. Mamman ritar illustrationer och skickar dem till staden. Pappan börjar använda båthuset som sin ateljé, och det blir en helig plats som ingen får röra. På stranden är det lugnt, och båtarna får stanna vid bryggan.
Det är en het sommar, och livet kretsar kring ritandet, fiskandet och familjens rutiner. Mamman fortsätter rita och hoppar i vattnet för att svalka sig, medan pappan jobbar i sin ateljé och fiskar för sig själv. Kallebisin har sina sommargäster, och alla hittar sitt eget sätt att njuta av sommaren.
Men så händer något oväntat: vattnet stiger snabbt på natten och täcker stora delar av området. Familjen och gästerna kämpar för att rädda saker från båthuset och stranden. Trots kaoset finns det ögonblick av glädje när de tillsammans försöker hantera situationen. När vattnet slutligen sjunker tillbaka, är båthuset fortfarande fullt av lera och förstört, men familjen ser ändå ljuset i situationen och finner en sorts lättnad.
',
